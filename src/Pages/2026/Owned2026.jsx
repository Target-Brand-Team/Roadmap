...
import { OWNED_BRAND_DATA_2026 } from "./../../Database_2024/2026/OwnedData2026";
import { ToggleContext } from "../../components/CONTEXT/ToggleContextPage";

const Owned2026 = () => {
  const [ownedData, setownedData] = useState(OWNED_BRAND_DATA_2026);
        ...
        <div className="bg-white h-[1500px] w-full flex mb-10">
          <section className="w-full flex flex-col gap-1">
            ...
            {essentialToggle ? (
              ...
              >
                <HiChevronDown className="ml-2 text-xl" />
                <h3 className="ml-[460px]">Everyday Care</h3>
              </div>
            ) : (
              <div className="shadow h-48 flex flex-wrap relative">
                <div
            ...
            {foodToggle ? (
              ...
              >
                <HiChevronDown className="ml-2 text-xl" />
                <h3 className="ml-[455px]">Food & Beverage</h3>
              </div>
            ) : (
              <div className="shadow h-[230px] flex flex-wrap relative">
                <div
                  className="vertical flex items-center text-[13px] pt-11 text-white bg-green-600 text-center font-semibold p-2 hover:bg-green-950 cursor-pointer rounded-tr-md rounded-br-md"
                  onClick={() => setFoodToggle(true)}
                >
                  <span>Food & Beverage</span>
                  <HiChevronDown className="text-xl mt-10" />
                </div>
