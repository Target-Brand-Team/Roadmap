...
import { CULTURAL_CONTEXT_LINKS_2026 } from '../../Database_2024/2026/CulturalData2026';
      ...
      {mainBarToggle ? (
        <div className=" flex">
          ...
          <main className="max-[1280px]:w-[252px] bg-white shadow rounded pt-1  border border-gray-200 flex gap-1 ">
            {/* ====   FEBRUARY EVENTS ==== */}
            <div>
              {CULTURAL_CONTEXT_LINKS_2026?.FEBRUARY?.map((item) => (
                <div
                  key={item.key}
            ...
            {/* ====   MARCH EVENTS ==== */}
            <div>
              {CULTURAL_CONTEXT_LINKS_2026?.MARCH?.map((item) => (
                <div
                  key={item.key}
            ...
            {/* ====   APRIL EVENTS ==== */}
            <div>
              {CULTURAL_CONTEXT_LINKS_2026?.APRIL?.map((item) => (
                <div
                  key={item.key}
                  className="max-[1280px]:w-[80px] max-[1280px]:text-[12px] text-gray-700 w-32 font-medium text-center p-1 mb-1 shadow-md rounded-md"
                >
          ...
          <main className="max-[1280px]:w-[220px] bg-white shadow rounded pt-1 gap-1 flex-1 border border-gray-200 flex ">
            {/* ====   MAY EVENTS ==== */}
            <div>
              {CULTURAL_CONTEXT_LINKS_2026?.MAY?.map((item) => (
                <div
                  key={item.key}
            ...
            {/* ====   JUNE EVENTS ==== */}
            <div>
              {CULTURAL_CONTEXT_LINKS_2026?.JUNE?.map((item) => (
                <div
                  key={item.key}
            ...
            {/* ====   JULY EVENTS ==== */}
            <div>
              {CULTURAL_CONTEXT_LINKS_2026?.JULY?.map((item) => (
                <div
                  key={item.key}
                  className="max-[1280px]:w-[80px] max-[1280px]:text-[12px] text-gray-700 w-32 font-medium text-center p-1 mb-1 shadow-md rounded-md"
                >
          ...
          <main className="max-[1280px]:w-[220px] bg-white shadow rounded pt-1 gap-1 flex-1 border border-gray-200 flex">
            {/* ====   AUG EVENTS ==== */}
            <div>
              {CULTURAL_CONTEXT_LINKS_2026?.AUGUST?.map((item) => (
                <div
                  key={item.key}
                  className="max-[1280px]:w-[80px] max-[1280px]:text-[12px] text-gray-700 w-32 font-medium text-center p-1 mb-1 shadow-md rounded-md"
                >
            ...
            {/* ====   SEPT EVENTS ==== */}
            <div>
              {CULTURAL_CONTEXT_LINKS_2026?.SEPTEMBER?.map((item) => (
                <div
                  key={item.key}
                  className="max-[1280px]:w-[80px] max-[1280px]:text-[12px] text-gray-700 w-32 font-medium text-center p-1 mb-1 shadow-md rounded-md"
                >
            ...
            {/* ====   OCT EVENTS ==== */}
            <div>
              {CULTURAL_CONTEXT_LINKS_2026?.OCTOBER?.map((item) => (
                <div
                  key={item.key}
                  className="max-[1280px]:w-[80px] max-[1280px]:text-[12px] text-gray-700 w-32 font-medium text-center p-1 mb-1 shadow-md rounded-md"
                >
          ...
          <main className="max-[1280px]:w-[220px] bg-white shadow rounded pt-1 gap-1 flex-1 border border-gray-200 flex">
            {/* ====   NOV EVENTS ==== */}
            <div>
              {CULTURAL_CONTEXT_LINKS_2026?.NOVEMBER?.map((item) => (
                <div
                  key={item.key}
                  className="max-[1280px]:w-[80px] max-[1280px]:text-[12px] text-gray-700 w-32 font-medium text-center p-1 mb-1 shadow-md rounded-md"
                >
            ...
            {/* ====   DEC EVENTS ==== */}
            <div>
              {CULTURAL_CONTEXT_LINKS_2026?.DECEMBER?.map((item) => (
                <div
                  key={item.key}
                  className="max-[1280px]:w-[80px] max-[1280px]:text-[12px] text-gray-700 w-32 font-medium text-center p-1 mb-1 shadow-md rounded-md"
                >
            ...
            {/* ====   JAN EVENTS ==== */}
            <div>
              {CULTURAL_CONTEXT_LINKS_2026?.JANUARY?.map((item) => (
                <div
                  key={item.key}
                  className="max-[1280px]:w-[80px] max-[1280px]:text-[12px] text-gray-700 w-32 font-medium text-center p-1 mb-1 shadow-md rounded-md"
                >
