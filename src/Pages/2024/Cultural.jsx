...
const Cultural = () => {
  return (
    <div className=" flex h-48">
      ...
      {/* ====   FIRST QUATER Q1  ==== */}
      <main className="max-[1280px]:w-[241px] bg-white shadow rounded p-2 gap-3 flex-1 border border-gray-200 flex justify-center items-center ">
        {/* ====   FEBRUARY EVENTS ==== */}
        <div>
      ...
      {/* ====   SECOND QUATER Q1  ==== */}
      <main className="max-[1280px]:w-[243px] bg-white shadow rounded p-2 gap-3 flex-1 border border-gray-200 flex justify-center items-center ">
        {/* ====   MAY EVENTS ==== */}
        <div>
